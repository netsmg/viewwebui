...
<head>
	...
	<meta name="author" content="Netsmg">
	<title>Home | webui</title>
...
<!-- header -->
					...
					<div class="col-12">
						<div class="header__content">
							...
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									<a class="header__nav-link" href="#" role="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">News</a>
								...
								<li class="header__nav-item">
									<a class="header__nav-link" href="#" role="button" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							...
							<div class="header__actions">
								<div class="header__lang">
									<a class="header__lang-btn" href="#" role="button" id="dropdownMenuLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<img src="https://flixhub.volkovdesign.com/img/flags/uk.svg" alt="">
										<span>EN</span>
									...
									<ul class="dropdown-menu header__lang-menu" aria-labelledby="dropdownMenuLang">
										<li><a href="/"><img src="https://flixhub.volkovdesign.com/img/flags/spain.svg" alt=""><span>SP</span></a></li>
										<li><a href="#"><img src="https://flixhub.volkovdesign.com/img/flags/russia.svg" alt=""><span>RU</span></a></li>
										<li><a href="#"><img src="https://flixhub.volkovdesign.com/img/flags/china.svg" alt=""><span>CH</span></a></li>
									</ul>
								</div>
	...
	<!-- home -->
	<section class="section section--bg section--carousel section--first" data-bg="img/bg.jpg">
		<div class="container">
			<div class="row">
				<!-- title -->
				<div class="col-12">
		...
		<div class="owl-carousel section__carousel section__carousel--big" id="carousel0">
			...
			<div class="card card--big">
				...
				<div class="card__wrap">
					...
					<div class="card__price">
						<span>Free</span><s>$38.80</s><b>100% OFF</b>
					</div>

					<div class="card__actions">
						<button class="card__buy" type="button">Download</button>
				...
				<div class="col-12">
					<div class="partners owl-carousel">
						<a href="#" class="partners__img">
							<img src="https://flixhub.volkovdesign.com/img/partners/3docean-light-background.png" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="https://flixhub.volkovdesign.com/img/partners/activeden-light-background.png" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="https://flixhub.volkovdesign.com/img/partners/audiojungle-light-background.png" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="https://flixhub.volkovdesign.com/img/partners/codecanyon-light-background.png" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="https://flixhub.volkovdesign.com/img/partners/photodune-light-background.png" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="https://flixhub.volkovdesign.com/img/partners/themeforest-light-background.png" alt="">
						</a>
					</div>
				</div>
			</div>
